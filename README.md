...
동일한 항목코드(예: 3-1-1)가 여러 부문에 있을 수 있습니다. 이 경우 어느 부문인지 되물어보므로,
`"토목부문 3-1-1 보여줘"`처럼 부문을 함께 말하면 바로 조회됩니다.
...
- 검색 결과가 1,092개 항목 중 원하는 게 없다면, 이는 검색 범위(공통·토목·건축·기계설비·유지관리 5개 부문)에 포함되지 않은 항목일 수 있습니다.
